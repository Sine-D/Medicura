                    ...
                    <div className='mt-8'>
                        <div className='bg-white shadow rounded-lg'>
                            <div className='px-4 py-5 sm:p-6'>
                                <h3 className='text-lg leading-6 font-medium text-gray-900 mb-4'>Recent Lab Tests</h3>
                                <div className='space-y-4'>
                                    <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
                                        <div>
                                            <p className='font-medium'>Blood Test - Patient #1234</p>
                                            <p className='text-sm text-gray-500'>Sample collected at 9:30 AM</p>
                                        </div>
                                        <span className='px-2 py-1 text-xs font-semibold text-green-800 bg-green-100 rounded-full'>Completed</span>
                                    </div>
                                    <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
                                        <div>
                                            <p className='font-medium'>Urine Test - Patient #1235</p>
                                            <p className='text-sm text-gray-500'>Sample collected at 10:15 AM</p>
                                        </div>
