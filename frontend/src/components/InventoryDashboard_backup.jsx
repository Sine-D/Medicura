...
const InventoryDashboard = () => {
  ...
  useEffect(() => {
    const applyTheme = (t) => {
      ...
      if (t === "Dark") {
        ...
        body.style.color = "#e5e7eb"; // gray-200
  ...
  const handleAddNewItem = () => {
    // Open add item modal on dashboard
  ...
  const handleManageUsers = () => {
    ...
    // In a real app, this would open user management modal
  ...
  const handleActivityClick = (activityType, activityId) => {
    ...
    // In a real app, this would navigate to the specific activity or show details
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-3xl font-bold text-gray-900 mb-1">
                      {card.title === "Total Value" ? `$${card.value.toLocaleString()}` : card.value.toLocaleString()}
                    </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <button 
              ...
              className="group relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-2xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 flex flex-col items-center space-y-3 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              ...
              <div className="relative z-10 p-3 bg-white bg-opacity-20 rounded-xl">
                <Package className="h-8 w-8" />
              </div>
              <div className="relative z-10 text-center">
                <span className="font-semibold text-lg">Add Item</span>
                <p className="text-blue-100 text-sm mt-1">Create new inventory</p>
              </div>
            </button>
            <button 
              onClick={handleGenerateReport}
              className="group relative overflow-hidden bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-2xl hover:from-green-600 hover:to-green-700 transition-all duration-300 flex flex-col items-center space-y-3 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              <div className="absolute top-0 right-0 w-16 h-16 bg-white opacity-10 rounded-bl-full transform translate-x-4 -translate-y-4"></div>
              <div className="relative z-10 p-3 bg-white bg-opacity-20 rounded-xl">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-green-100 text-sm mt-1">Export analytics</p>
              </div>
            </button>
            <button 
              onClick={handleManageUsers}
              className="group relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-2xl hover:from-purple-600 hover:to-purple-700 transition-all duration-300 flex flex-col items-center space-y-3 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              <div className="absolute top-0 right-0 w-16 h-16 bg-white opacity-10 rounded-bl-full transform translate-x-4 -translate-y-4"></div>
              <div className="relative z-10 p-3 bg-white bg-opacity-20 rounded-xl">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-purple-100 text-sm mt-1">User administration</p>
              </div>
            </button>
          </div>
        </div>
